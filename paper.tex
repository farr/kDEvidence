...
chain.  One of the first papers to address this issue was Reference
\cite{Littenberg2009}, where the authors propose a method for
producing inter-model jumps in an RJMCMC that relies on interpolating
single-model posterior distributions using a box decomposition of
parameter space.  
