...
\begin{abstract}
  Selection among alternative theoretical models given an observed data set is an important challenge in many areas of physics and astronomy, ranging from gravitational-wave data analysis to measurements of black-hole masses in X-ray binaries.  Reversible-jump Markov chain
...
variance and a possible bias \cite{NewtonRaftery:1994,Chib:1995,vanHaasteren:2009}.  Additional techniques for the direct integration of evidence, also based on a kD tree decomposition of the
