...
``burn-in'' points. \ilya{[Up to this paragraph, we mostly use "samples", not "samples"; for the rest of the paper, we mostly use "points", with occasional sliding back to "samples".  I don't have a preference, but it might be better to use uniform terminology.]}
